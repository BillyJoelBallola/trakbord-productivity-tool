...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("", className)} // not-last:border-b data-open:bg-muted/50
      {...props}
    />
  );
}
...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-(--radix-accordion-content-height) pt-0 pb-4 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground",
          className,
        )}
      >
        {children}
